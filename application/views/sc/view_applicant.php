        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <!-- Application Details -->
                    <div class="col-md-8">
                        <form method="post" action="<?= site_url('twc/update_review_status'); ?>">
                            <div class="form-row">
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="number" class="form-control" id="discount" value="<?= htmlspecialchars($applicant->discount); ?>" readonly>
                                </div>
                            ...
                            <a href="<?= site_url('sc/app_evaluation'); ?>" class="btn btn-secondary">Back</a>
                        </form>
                    </div>
                </div>
            </div>
