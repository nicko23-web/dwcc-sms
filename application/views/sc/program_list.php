...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="container-fluid">
            <!-- Merit Programs Section -->
            <h4 class="mb-3">Merit Programs</h4>
            <div class="row mb-3">
                <?php if (isset($programs) && !empty($programs)): ?>
                        ...
                        <?php if ($program->scholarship_type == 'Merit'): ?>
                            <div class="col-lg-6 col-6 mb-3">
                                <div class="small-box bg-success">
                                    ...
                                    <a href="<?= site_url('sc/final_list/'.$program->program_code); ?>" class="small-box-footer">
                    ...
                    <?php endforeach; ?>
                <?php else: ?>
                    <p>No merit scholarship programs available.</p>
                <?php endif; ?>
            </div>

            <!-- Non-Merit Programs Section -->
            <h4 class="mb-3">Non-Merit Programs</h4>
            <div class="row">
                <?php if (isset($programs) && !empty($programs)): ?>
                    <?php foreach ($programs as $program): ?>
                    ...
                    <?php endforeach; ?>
                <?php else: ?>
                    <p>No non-merit scholarship programs available.</p>
                <?php endif; ?>
            </div>
        </div>
    </section>
