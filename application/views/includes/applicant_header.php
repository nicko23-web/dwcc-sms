      ...
      <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
            <a href="<?= base_url('applicant/update_info'); ?>" class="dropdown-item">
              <i class="fas fa-user-edit mr-2"></i> Edit Information
            </a>
            <div class="dropdown-divider"></div>
            <a href="<?= base_url('applicant/change_password'); ?>" class="dropdown-item">
        ...
        <!-- Logout Button -->
        <li class="nav-item">
          <a class="nav-link" href="<?= site_url('auth/applicant_logout') ?>" role="button">
